...
void CClientShadowMgr::ComputeShadowTextures( const CViewSetup &view, int leafCount, LeafIndex_t* pLeafList )
{
	...
	//threadedshadows (I didnt change this at all, just marking it here in case i do need to)
...
//global_light (commented out for RTT shadows, plus this is useless anyway)
/*
