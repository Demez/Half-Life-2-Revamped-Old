...
#include "missionchooser/iHL2R_mission_chooser.h"
#include "missionchooser/iHL2R_mission_chooser_source.h"
#elif defined( REVAMPED_CLIENT ) || defined( HL2MP )
//#include "matchmaking/hl2mp/imatchext_hl2mp.h"
