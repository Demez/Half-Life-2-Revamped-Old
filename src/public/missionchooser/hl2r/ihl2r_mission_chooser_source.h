#ifndef _INCLUDED_IHL2R_MISSION_CHOOSER_SOURCE_H
#define _INCLUDED_IHL2R_MISSION_CHOOSER_SOURCE_H
#ifdef _WIN32
#pragma once
#endif
...
struct HL2R_Mission_Chooser_Saved_Campaign
{
...
#define HL2R_MISSIONS_PER_PAGE 8
#define HL2R_CAMPAIGNS_PER_PAGE 3
#define HL2R_SAVES_PER_PAGE 8

abstract_class IHL2R_Mission_Chooser_Source
{
public:
	...
	virtual HL2R_Mission_Chooser_Mission* GetMissions() = 0;	// pass an array of mission names back
	virtual HL2R_Mission_Chooser_Mission* GetMission( int nIndex, bool bRequireOverview ) = 0;	// may return NULL if asking for a mission outside of the found range
	virtual int	 GetNumMissions(bool bRequireOverview) = 0;
	
	virtual void FindCampaigns(int nCampaignOffset, int iNumSlots) = 0;
	virtual HL2R_Mission_Chooser_Mission* GetCampaigns() = 0;	// Passes an array of campaign names back
	virtual HL2R_Mission_Chooser_Mission* GetCampaign( int nIndex ) = 0;		// may return NULL when requesting a campaign outside the found range
	...
	virtual HL2R_Mission_Chooser_Saved_Campaign* GetSavedCampaigns() = 0;	// passes an array of summary data for each save
	virtual HL2R_Mission_Chooser_Saved_Campaign* GetSavedCampaign( int nIndex, bool bMultiplayer, const char *szFilterID ) = 0;	// may return NULL when requesting a save outside the found range
	...
	virtual bool HL2R_Campaign_CreateNewSaveGame(char *szFileName, int iFileNameMaxLen, const char *szCampaignName, bool bMultiplayerGame, const char *szStartingMission) = 0;
...
#endif // _INCLUDED_IHL2R_MISSION_CHOOSER_SOURCE_H
